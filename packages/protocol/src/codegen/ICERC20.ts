...
export interface ICERC20 extends Contract<ICERC20> {
  accrueInterest: Send<() => BigNumber, ICERC20>
  ...
  borrow: Send<(arg0: BigNumberish) => BigNumber, ICERC20>
  borrowBalanceStored: Call<(arg0: AddressLike) => BigNumber, ICERC20>
  ...
  repayBorrow: Send<(arg0: BigNumberish) => BigNumber, ICERC20>
