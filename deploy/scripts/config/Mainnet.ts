...
const atokens = {
  ...
  abusd: ['0xe0c688783c19a648f82176b0df3151B5C1613daa', primitives.busd] as [string, string],
  ...
  aenj: ['0xf3C43842c80aF92b04E134E81FB5B8EC25Bc70A1', primitives.enj] as [string, string],
  aknc: ['0x06F281B2C3fB2358e8Dd8BC67854a60D12d5495e', primitives.kncl] as [string, string],
  alink: ['0xDc51406f81143CfA75D3395B1d5ED30a2437AB74', primitives.link] as [string, string],
  amana: ['0xAA4C63808e612A8e92C3b6D1D2932668102B5b27', primitives.mana] as [string, string],
  amkr: ['0x8136E35C120D60A050cf7399eE74f4e137342b4C', primitives.mkr] as [string, string],
  aren: ['0x004E2fb2F10032414dBFF6f2E7105059627f6B26', primitives.ren] as [string, string],
  asnx: ['0xC882A158C1a1cB4492B20Ea34956a4B8477d0718', primitives.snx] as [string, string],
  asusd: ['0x87BACb4de1D9C4fd57499BE41075564cF14365A3', primitives.susd] as [string, string],
  auni: ['0x9686C45B7beB1A87922bC5F6a34eCEEb0e23b9ea', primitives.uni] as [string, string],
  ausdc: ['0x8Ed0b476d15Ced0AA82ED2E8F4f9469dD0374950', primitives.usdc] as [string, string],
  ausdt: ['0x762d78D34F8fc48825efbEe7062D74aadC2aef71', primitives.usdt] as [string, string],
...
const mainnetConfig: DeploymentConfig = {
  aave: {
    ...
    protocolDataProvider: '0x71089Ba41e478702e1904692385Be3972B2cBf9e',
  },
  chainlink: {
    aggregators,
