...
const primitives = {
  aave: '0x0ed64d01D0B4B655E410EF1441dD677B695639E7',
  adx: '0xade00c28244d5ce17d72e40330b1c318cd12b7c3',
  ant: '0xa117000000f279d81a1d3cc75430faa017fa5a2e',
  bal: '0xba100000625a3754423978a60c9317c58a424e3d',
  bat: '0x40a42Baf86Fc821f972Ad2aC878729063CeEF403',
  bnb: '0xB8c77482e45F1F44dE1745F52C74426C631bDD52',
  bnt: '0x1f573d6fb3f13d689ff844b4ce37794d79a7ff1c',
  busd: '0x74Cf9087AD26D541930BaC724B7ab21bA8F00a27',
  //bzrx: '0x56d811088235f11c8920698a204a5010a788f4b3',
  comp: '0xc00e94Cb662C3520282E6f5717214004A7f26888',
  cro: '0xa0b73e1ff0b80914ab6fe0444e65848c4c34450b',
  crv: '0xd533a949740bb3306d119cc777fa900ba034cd52',
  dai: '0x5302E909d1e93e30F05B5D6Eea766363D14F9892',
  enj: '0x26B862f640357268Bd2d9E95bc81553a2Aa81D7E',
  knc: '0xdefa4e8a7bcba345f687a2f1456f5edd9ce97202',
  kncl: '0xdd974D5C2e2928deA5F71b9825b8b646686BD200',
  link: '0xc582Bc0317dbb0908203541971a358c44b1F3766',
  lrc: '0xbbbbca6a901c926f240b89eacb641d8aec7aeafd',
  mana: '0xB377a2EeD7566Ac9fCb0BA673604F9BF875e2Bab',
  mkr: '0xD49a0e9A4CD5979aE36840f542D2d7f02C4817Be',
  mln,
  nmr: '0x1776e1f26f98b1a5df9cd347953a26dd3cb46671',
  oxt: '0x4575f41308ec1483f3d399aa9a2826d74da13deb',
  ren: '0x66F625B8c4c635af8b74ECe2d7eD0D58b4af3C3d',
  ...
  tusd: '0x4bf010f1b9beDA5450a8dD702ED602A104ff65EE',
  uni: '0x70bDA08DBe07363968e9EE53d899dFE48560605B',
  usdc: '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48',
  usdt: '0xde2Bd2ffEA002b8E84ADeA96e5976aF664115E2c',
  wbtc: '0xe1Fd27F4390DcBE165f4D60DBF821e4B9Bb02dEd',
  wnxm: '0x0d438f3b5175bebc262bf23753c1e53d03432bde',
  yfi: '0xaca81583840B1bf2dDF6CDe824ada250C1936B4D',
  zrx: '0x870526b7973b56163a6997bB7C886F5E4EA53638',
} as const;
...
const atokens = {
  aaave: ['0x94CF339f91Ff6f6b583a3D1404DE00C5aD100897', primitives.aave] as [string, string],
  abal: ['0x272F97b7a56a387aE942350bBC7Df5700f8a4576', primitives.bal] as [string, string],
  abusd: ['0x519c44297ae89b3845cb3a46938c9Ee4C0b37835', primitives.busd] as [string, string],
  acrv: ['0x8dAE6Cb04688C62d939ed9B68d32Bc62e49970b1', primitives.crv] as [string, string],
  adai: ['0x586F1D39aDFdB289e4A1D3C124bd35fAc148225e', primitives.dai] as [string, string],
  aenj: ['0x71d1C9e5e984D0026A35Fc7d0561CAb0a0D3190A', primitives.enj] as [string, string],
  aknc: ['0x39C6b3e42d6A679d7D776778Fe880BC9487C2EDA', primitives.kncl] as [string, string],
  alink: ['0x47CA2baBfdB3C0582E442663F71FcbA6fa42edD6', primitives.link] as [string, string],
  amana: ['0x78ebFDE0F00b467b21A026bbe0E40F34284A3377', primitives.mana] as [string, string],
  amkr: ['0x7CF06210Baa3879fbAa26c69F65361AeDB15aeaC', primitives.mkr] as [string, string],
  aren: ['0x600Dc4F3356CDf3018911404551383c06Edd6390', primitives.ren] as [string, string],
  ...
  auni: ['0xfcf8213DDce1627Ac3849ae620503f158817b730', primitives.uni] as [string, string],
  ausdc: ['0xBcca60bB61934080951369a648Fb03DF4F96263C', primitives.usdc] as [string, string],
  ausdt: ['0xf528D466778717447CA5D8deCCd16734d1AaE9F8', primitives.usdt] as [string, string],
  awbtc: ['0xcAe116aF034b52F9fB1ef54B24764dEBe2F024aC', primitives.wbtc] as [string, string],
  aweth: ['0x030bA81f1c18d280636F32af80b9AAd02Cf0854e', weth] as [string, string],
  ayfi: ['0xf8CE844C61B7C62fcD48362fF08057Dd796Ce362', primitives.yfi] as [string, string],
  azrx: ['0x1C7302a645370093BaBd99C77348851f359DC3cE', primitives.zrx] as [string, string],
};
...
const mainnetConfig: DeploymentConfig = {
  aave: {
    ...
    lendingPoolAddressProvider: '0x63fea6E447F120B8Faf85B53cdaD8348e645D80E',
    protocolDataProvider: '0x158d291D8b47F056751cfF47d1eEcd19FDF9B6f8',
  },
  chainlink: {
    aggregators,
